...
export function validateRegistration({ name, email, password, passwordConfirm }) {
  ...
  if (passwordConfirm !== undefined && password !== passwordConfirm) return 'Passwords do not match'
  return null
}
